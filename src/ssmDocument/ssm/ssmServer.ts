...
import { JsonLS, getLanguageServiceSSM as getLanguageService } from 'ssm-languageService'
...
function schemaRequestPlaceHolder(uri: string): Thenable<string> {
    return Promise.resolve(uri) as Thenable<string>
}

// create the JSON language service
let languageService = getLanguageService({
    schemaRequestPlaceHolder,
    workspaceContext,
    contributions: [],
...
connection.onInitialize(
    (params: InitializeParams): InitializeResult => {
        languageService = getLanguageService({
            schemaRequestService: schemaRequestPlaceHolder,
            workspaceContext,
            contributions: [],
...
connection.onCompletion((textDocumentPosition, token) => {
    console.log(`${textDocumentPosition.position.line}, ${textDocumentPosition.position.character}`)
    console.log(textDocumentPosition.context?.triggerCharacter)
    return runSafeAsync(
        async () => {
